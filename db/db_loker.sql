...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 15 Sep 2022 pada 08.32
...
CREATE TABLE `berkas` (
  ...
  `berkas_1` varchar(255) NOT NULL,
  `berkas_2` varchar(255) NOT NULL,
  `berkas_3` varchar(255) NOT NULL,
  `berkas_4` varchar(255) NOT NULL,
